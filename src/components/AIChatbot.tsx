            ...
            {!isOpen && (
                <div className="fixed bottom-6 right-6 flex flex-col items-end z-50">
                    ...
                    <div className="relative mb-3 animate-pulse">
                        <div className="bg-white/90 border border-border shadow-md rounded-lg px-4 py-2 text-sm text-gray-600 font-medium min-w-[140px] text-left">
                            Ask me anything..
                        </div>
                        {/* Speech bubble stem at bottom right */}
                        <span className="absolute -bottom-2 right-4 w-0 h-0 border-t-[10px] border-t-white/90 border-x-[8px] border-x-transparent border-b-0"></span>
                        <span
