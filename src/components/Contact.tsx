            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        ...
                        experts to discuss how we can help you achieve your
                    ...
                    <div className="space-y-8 animate-slide-up">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-muted-foreground">
                                Our team is ready to help you navigate your
                                digital transformation journey. Reach out to us
                        ...
                        <div className="space-y-4">
                            <Button
                                ...
                                size="lg"
                                className="w-full hover:bg-[#25D366] hover:text-white transition-colors"
                                onClick={() =>
                                    window.open(
                                        "https://wa.me/message/7WBM2HJVCKXFP1",
                                        "_blank"
                                    )
                                }
                                type="button">
