            ...
            <div className="container mx-auto px-4 py-16">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-background/80 leading-relaxed">
                                Empowering small-scale businesses with tailored
                                software tools, strategic data consultancy, and
                                AI solutions for sustainable success.
                            </p>
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            <li className="text-background/80 hover:text-primary transition-colors">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <h5 className="font-medium text-background">
                                Follow Us
                            </h5>
                ...
                >
                  <Facebook className="w-5 h-5" />
                                ...
                                <a
                                    href="https://youtu.be/i436UAbhMoI?si=FoE7xIu5YWYtEWJw"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-background/10 rounded-full flex items-center justify-center text-background/80 hover:bg-primary hover:text-background transition-colors">
                                ...
                                <a
                                    href="https://instagram.com/anxoda.business"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-background/10 rounded-full flex items-center justify-center text-background/80 hover:bg-primary hover:text-background transition-colors">
