...
const achievements = [
    ...
    },
    {
        icon: Clock,
        title: "5+",
        subtitle: "Proven Tools",
        description: "Innovative solutions for business growth and efficiency",
    },
    {
        icon: Target,
        title: "10+",
                ...
                <div className="mb-16 lg:mb-20">
                    <div className="text-center mb-12 animate-fade-in">
                        ...
                        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
                            Our experienced leaders are dedicated to driving
                            your business success through innovative solutions
                    ...
                    {achievements.map((achievement, index) => (
                        <Card
                            ...
                            <CardContent className="p-4 sm:p-6 lg:p-8">
                                ...
                                <div className="font-semibold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">
