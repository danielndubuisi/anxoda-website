...
const Index = () => {
    return (
        <div className="min-h-screen">
            <SEOHead
                title="Anxoda"
                description="Business Intelligence & Profit Planning for African SMBs. Know if your business is truly profitable. Anxoda helps African small businesses find their break-even point, analyze spreadsheets, and make smarter profit decisions with AI."
