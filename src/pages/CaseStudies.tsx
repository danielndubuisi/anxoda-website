...
const caseStudies = [
  {
    ...
    industry: "Retail",
    challenge: "Outdated e-commerce platform with poor user experience and declining sales",
    solution: "Complete platform rebuild with modern UI/UX, mobile optimization, and AI-powered recommendations",
    results: [
  ...
  },
  {
    ...
    challenge: "Lack of real-time insights into production efficiency and quality metrics",
    solution: "Custom analytics dashboard with real-time data visualization and predictive maintenance alerts",
    results: [
    ...
    technologies: ["Python", "Power BI", "Azure", "IoT", "Machine Learning"]
  },
  {
    title: "CRM System Implementation",
    client: "Service-Based SME",
    industry: "Professional Services",
    challenge: "Manual customer management processes leading to missed opportunities",
    solution: "Custom CRM system with automated workflows, lead scoring, and customer communication tools",
    results: [
    ...
    technologies: ["React", "Laravel", "MySQL", "API Integration", "Automation"]
  }
];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              and efficiency through tailored digital solutions.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <div className={`${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                    <div className="aspect-video bg-gradient-to-br from-primary/20 to-primary/5 rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        <div className="text-4xl font-bold text-primary mb-2">{study.client}</div>
                        <div className="text-muted-foreground">{study.industry}</div>
                      </div>
                    </div>
                  </div>
                  
                  <div className={`space-y-6 p-8 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                    <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {study.results.map((result, idx) => (
                        <div key={idx} className="bg-gradient-subtle p-4 rounded-lg">
                          <div className="flex items-center space-x-2 mb-2">
                            <result.icon className="w-5 h-5 text-primary" />
                            <div className="font-semibold text-foreground">{result.value}</div>
                          </div>
